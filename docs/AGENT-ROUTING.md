...
| Lowered IR or interpreter speed | `docs/FRONTEND.md`; `docs/COMPACT-LOWERABILITY.md`; `perf/README.md`; `docs/ARCHITECTURE.md` Agent Map For IR Work | `src/runtime/eval/lower.rs`, `lowered_ops.rs`, `lowered_run.rs`, `src/runtime/eval.rs` | `tools/xsh-ir-coverage.xsh`, `perf/interpreter/*`, targeted runtime tests |
