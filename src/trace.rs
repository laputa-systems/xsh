...
pub enum TraceKind {
    ...
    NetJobScheduled,
    NetTransportStarted,
    NetTransportCompleted,
    NetJobWait,
    NetJobCancel,
    NetJobCleanup,
    NetJobShutdownCancel,
    NetRuntimeFailure,
    PipelineEnter,
    PipelineExit,
...
impl TraceKind {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NetJobAccepted => "net.job.accepted",
            Self::NetJobScheduled => "net.job.scheduled",
            Self::NetTransportStarted => "net.transport.started",
            Self::NetTransportCompleted => "net.transport.completed",
            Self::NetJobWait => "net.job.wait",
            Self::NetJobCancel => "net.job.cancel",
            Self::NetJobCleanup => "net.job.cleanup",
            Self::NetJobShutdownCancel => "net.job.shutdown_cancel",
            Self::NetRuntimeFailure => "net.runtime.failure",
