...
fn guide_markdown(chapters: &[ChapterDoc]) -> String {
    ...
    output.push_str("Markdown under `docs/` is the primary generated artifact for agents, code review, and repository navigation. It is generated from the templates under `docs-src/` and checked for drift by `xsht docs check`.\n\n");
