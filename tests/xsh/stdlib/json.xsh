...
proc test_json_get_overloads_and_encoded_lines() [error] {
  ...
  test.eq(json.encode_lines([1])?, "1\n")?
  test.eq(json.encode_lines([1, "two", null, true])?, "1\n\"two\"\nnull\ntrue\n")?
  test.eq(json.encode_lines(["a\"b"])?, "\"a\\\"b\"\n")?
  test.eq(json.encode_lines(["a\nb"])?, "\"a\\nb\"\n")?
  test.eq(json.encode_lines([value, value])?, "{\"items\":[1,2],\"name\":\"pkg\",\"nil\":null}\n{\"items\":[1,2],\"name\":\"pkg\",\"nil\":null}\n")?
