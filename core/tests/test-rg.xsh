...
proc test_rg_reports_matches_with_line_numbers(ctx: TestContext) [env, fs, process, error] {
...
proc test_rg_count_and_filename(ctx: TestContext) [env, fs, process, error] {
...
proc test_rg_word_line_pattern_and_globs(ctx: TestContext) [env, fs, process, error] {
