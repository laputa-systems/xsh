...
proc test_env_assignment_runs_command() [env, process, error] {
...
proc test_env_split_string_runs_command() [env, process, error] {
...
proc test_env_split_string_as_single_shebang_arg_runs_command() [env, process, error] {
  let script = core_script("printenv.xsh")
...
proc test_env_uses_direct_xsh_shebang() [env, fs, error] {
