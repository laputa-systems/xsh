...
proc test_fd_finds_by_name_extension_and_type(ctx: TestContext) [env, fs, process, error] {
...
proc test_fd_hidden_and_glob(ctx: TestContext) [env, fs, process, error] {
...
proc test_fd_multiple_roots_exclude_depth_and_executable(ctx: TestContext) [env, fs, process, error] {
